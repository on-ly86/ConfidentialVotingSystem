...
async function main() {
  ...
  // Deploy the plain AnonymousReportPlatformFHE contract
  const AdvancedAnonymousCheckInFactory = await hardhatEthers.getContractFactory("AnonymousReportPlatformFHE", wallet);
  ...
  console.log("AnonymousReportPlatformFHE contract deployed at:", deployedAddress);
  ...
  if (!fs.existsSync(frontendConfigDir)) {
    ...
    try {
      const artifactPath = path.join(
        ...
        "artifacts",
        "contracts",
        "AnonymousReportPlatformFHE.sol",
        "AnonymousReportPlatformFHE.json"
      );
      ...
      fs.copyFileSync(artifactPath, path.join(targetAbiPath, "AnonymousReportPlatformFHE.json"));
      console.log("Copied ABI to frontend/web/src/abi/AnonymousReportPlatformFHE.json");
    } catch (e) {
      console.warn(
        "Failed to copy ABI automatically. Please copy artifacts/.../AnonymousReportPlatformFHE.json manually to frontend/web/src/abi/AnonymousReportPlatformFHE.json",
        e
      );
    }
  }
